...
for(let i = 1; i <= 100; i++){ //inserire un for che conta da 1 a 100
    ...
    if ( (i%3 == 0) && (i%5 == 0) ) {
        ...
        cantainerVariabile.innerHTML += '<div class="box m3eem5">' + i + '</div>'
    } 
    else if  (i%3 == 0) {
        console.log('Fizz'); //multipli di tre al posto del numero scritta "Fizz"
        cantainerVariabile.innerHTML += '<div class="box m3">' + i + '</div>'
    } 
    else if (i%5 == 0) {
        console.log('Buzz'); //multipli di cinque al posto del numero scritta "Buzz"
        cantainerVariabile.innerHTML += '<div class="box m5">' + i + '</div>'
    }
    else {
